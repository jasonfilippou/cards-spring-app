...
public class JwtUserDetailsService implements UserDetailsService {
  ...
  /**
   * Load a user from the database given their email. The name of the method is confusing because that's how {@link UserDetailsService}
   * names it; don't shoot the messenger here. For our application, the username is the e-mail.
   * @param email the user's e-mail.
   * @return An instance of {@link org.springframework.security.core.userdetails.User}
